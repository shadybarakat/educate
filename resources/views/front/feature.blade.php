...
<body>
    ...
    <div class="jumbotron jumbotron-fluid position-relative overlay-bottom" style="margin-bottom: 90px;">
        <div class="container text-center my-5 py-5">
            ...
            <h1 class="text-white display-1 mb-5">category Courses</h1>
    ...
    <div class="container-fluid px-0 py-5">
        ...
        <div class="owl-carousel courses-carousel">
            ...
            <div class="courses-item position-relative">
                <img class="img-fluid" src="<?php echo url('/'); ?>/{{$course->course->image}}" alt="">
                <div class="courses-text">
                    <h4 class="text-center text-white px-3">{{$course->name}}</h4>
                    <div class="border-top w-100 mt-3">
                        <div class="d-flex justify-content-between p-4">
                            <span class="text-white"><i class="fa fa-user mr-2"></i>{{$course->course->name}}</span>
                            <span class="text-white"><i class="fa fa-star mr-2"></i>{{$course->course->Rating}} <small>(250)</small></span>
                        </div>
                    </div>
                    <div class="w-100 bg-white text-center p-4" >
                        <a class="btn btn-primary" href="{{ url('front/detail',$course->course->id) }}">Course Detail</a>
                    </div>
                </div>
            </div>
            @endforeach
