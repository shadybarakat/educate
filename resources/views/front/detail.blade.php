        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mx-auto py-0">
                    <a href="{{ url('front/index') }}" class="nav-item nav-link">Home</a>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="mb-5">
                        ...
                        <img class="img-fluid rounded w-100 mb-4" src="<?php echo url('/'); ?>/{{$course->image}}" alt="Image">
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    <div class="bg-primary mb-5 py-3">
                        ...
                        <div class="d-flex justify-content-between border-bottom px-4">
                            ...
                            <h6 class="text-white my-3">{{$course->Rating}} <small>(250)</small></h6>
                        </div>
                        <div class="d-flex justify-content-between border-bottom px-4">
                        ...
                        <div class="py-3 px-4">
                            <a class="btn btn-block btn-secondary py-3 px-5" href="{{ url('front/cart',$course->id)}}" id="demo" onclick="myFunction()">Enroll Now</a>
                        </div>
                    </div>
<script>
function myFunction() {
  document.getElementById("demo").innerHTML = "enrolled";
}
</script>
                    <div class="mb-5">
                        <h2 class="mb-3">Categories</h2>
                        @foreach($course->category_id as $category_name)
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                <a href="{{ url('front/feature',$category_name->category->id)}}" class="text-decoration-none h6 m-0">{{$category_name->category->name}}</a>
