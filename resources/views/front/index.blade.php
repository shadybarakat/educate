            ...
            <div class="row">
                <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="<?php echo url('/'); ?>/img/about.jpg" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-7">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="<?php echo url('/'); ?>/img/feature.jpg" style="object-fit: cover;">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="courses-text">
                    ...
                    <div class="border-top w-100 mt-3">
                        <div class="d-flex justify-content-between p-4">
                           <a href="{{ url('front/instructor',$course->instructor->id) }}"><span class="text-white"><i class="fa fa-user mr-2"></i>{{$course->instructor->name}}</span></a> 
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            ...
            @foreach($instructors as $instructor)
                <div class="team-item">
                 <img class="img-fluid w-100" src="<?php echo url('/'); ?>/{{$instructor->image}}" alt="">
                    <div class="bg-light text-center p-4">
                    <a href="{{ url('front/instructor',$instructor->id) }}"> <h5 class="mb-3">{{$instructor->name}}</h5></a>
                        <p class="mb-2">{{$instructor->department}}</p>
